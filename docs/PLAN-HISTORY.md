# Historical hackathon plan

Archived from PLAN.md after the refit milestone. This is historical context,
not the active queue or evidence that an item is complete. See [the current
checklist](../PLAN.md) and [demo runbook](../DEMO.md). Historical deadlines and
external-service configuration need rechecking before relying on them.
